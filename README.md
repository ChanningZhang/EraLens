...
- 组有独立起止（三国 220–280、五胡 304–439、南朝 420–589、五代 907–960）。外框按**组 span** 投影，不被成员更早建国年撑大（北魏 386、前凉 301、吴 902 可露在框外）。
...
| 类型 | 例子 |
|------|------|
| 自起始即正统 | 夏商西周东周、东汉、西东晋、隋唐、武周、北宋南宋、明、中华民国 |
