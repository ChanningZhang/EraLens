...
VALUES ('guan-yu', '关羽', 160, 1, 220, 1, ARRAY['将领'], '蜀汉名将，襄樊之战北伐曹魏，兵败被俘遇害。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/关羽"}]'::jsonb)
...
INSERT INTO persons (id, name, birth_year, birth_month, death_year, death_month, roles, bio, links)
VALUES ('zhang-fei', '张飞', 168, 1, 221, 6, ARRAY['将领'], '蜀汉名将，长坂之战掩护刘备撤退，后镇守阆中。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/张飞"}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, birth_year = EXCLUDED.birth_year, birth_month = EXCLUDED.birth_month, death_year = EXCLUDED.death_year, death_month = EXCLUDED.death_month, roles = EXCLUDED.roles, bio = EXCLUDED.bio, links = EXCLUDED.links;
INSERT INTO persons (id, name, birth_year, birth_month, death_year, death_month, roles, bio, links)
VALUES ('lu-xun', '陆逊', 183, 1, 245, 8, ARRAY['军事家','政治家'], '孙吴名将，夷陵之战、石亭之战主将，后官至丞相。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/陆逊"}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, birth_year = EXCLUDED.birth_year, birth_month = EXCLUDED.birth_month, death_year = EXCLUDED.death_year, death_month = EXCLUDED.death_month, roles = EXCLUDED.roles, bio = EXCLUDED.bio, links = EXCLUDED.links;
INSERT INTO persons (id, name, birth_year, birth_month, death_year, death_month, roles, bio, links)
VALUES ('huang-zhong', '黄忠', NULL, NULL, 220, 1, ARRAY['将领'], '蜀汉名将，定军山斩夏侯渊，助刘备夺取汉中。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/黄忠"}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, birth_year = EXCLUDED.birth_year, birth_month = EXCLUDED.birth_month, death_year = EXCLUDED.death_year, death_month = EXCLUDED.death_month, roles = EXCLUDED.roles, bio = EXCLUDED.bio, links = EXCLUDED.links;
INSERT INTO persons (id, name, birth_year, birth_month, death_year, death_month, roles, bio, links)
VALUES ('xiahou-yuan', '夏侯渊', NULL, NULL, 219, 1, ARRAY['将领'], '曹魏名将，镇守汉中，定军山之战阵亡。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/夏侯渊"}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, birth_year = EXCLUDED.birth_year, birth_month = EXCLUDED.birth_month, death_year = EXCLUDED.death_year, death_month = EXCLUDED.death_month, roles = EXCLUDED.roles, bio = EXCLUDED.bio, links = EXCLUDED.links;
INSERT INTO persons (id, name, birth_year, birth_month, death_year, death_month, roles, bio, links)
VALUES ('zhang-liao', '张辽', 169, 1, 222, 9, ARRAY['将领'], '曹魏名将，逍遥津之战以八百破孙权十万。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/张辽"}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, birth_year = EXCLUDED.birth_year, birth_month = EXCLUDED.birth_month, death_year = EXCLUDED.death_year, death_month = EXCLUDED.death_month, roles = EXCLUDED.roles, bio = EXCLUDED.bio, links = EXCLUDED.links;
INSERT INTO persons (id, name, birth_year, birth_month, death_year, death_month, roles, bio, links)
VALUES ('cao-ren', '曹仁', 168, 1, 223, 4, ARRAY['将领'], '曹魏名将，镇守樊城，襄樊之战拒关羽。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/曹仁"}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, birth_year = EXCLUDED.birth_year, birth_month = EXCLUDED.birth_month, death_year = EXCLUDED.death_year, death_month = EXCLUDED.death_month, roles = EXCLUDED.roles, bio = EXCLUDED.bio, links = EXCLUDED.links;
INSERT INTO persons (id, name, birth_year, birth_month, death_year, death_month, roles, bio, links)
VALUES ('ma-su', '马谡', NULL, NULL, 228, 1, ARRAY['将领'], '蜀汉将领，街亭之战违诸葛亮节度，兵败被斩。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/马谡"}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, birth_year = EXCLUDED.birth_year, birth_month = EXCLUDED.birth_month, death_year = EXCLUDED.death_year, death_month = EXCLUDED.death_month, roles = EXCLUDED.roles, bio = EXCLUDED.bio, links = EXCLUDED.links;
INSERT INTO persons (id, name, birth_year, birth_month, death_year, death_month, roles, bio, links)
VALUES ('zhang-he', '张郃', NULL, NULL, 231, 8, ARRAY['将领'], '曹魏名将，街亭之战击败马谡。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/张郃"}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, birth_year = EXCLUDED.birth_year, birth_month = EXCLUDED.birth_month, death_year = EXCLUDED.death_year, death_month = EXCLUDED.death_month, roles = EXCLUDED.roles, bio = EXCLUDED.bio, links = EXCLUDED.links;
INSERT INTO persons (id, name, birth_year, birth_month, death_year, death_month, roles, bio, links)
VALUES ('cao-xiu', '曹休', NULL, NULL, 228, 6, ARRAY['将领'], '曹魏宗室将领，石亭之战大败于陆逊。', '[{"label":"维基百科","url":"https://zh.wikipedia.org/wiki/曹休"}]'::jsonb)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, birth_year = EXCLUDED.birth_year, birth_month = EXCLUDED.birth_month, death_year = EXCLUDED.death_year, death_month = EXCLUDED.death_month, roles = EXCLUDED.roles, bio = EXCLUDED.bio, links = EXCLUDED.links;
...
-- events
INSERT INTO events (id, name, kind, time_mode, precision, date_note, at_year, at_month, at_abs, start_year, start_month, start_abs, end_year, end_month, end_abs, summary) VALUES ('changban', '长坂之战', 'battle', 'point', 'year', '建安十三年，208年，刘备南逃于长坂遭曹军追击', 208, 1, 2496, NULL, NULL, NULL, NULL, NULL, NULL, '曹操南下荆州，刘备携百姓南奔，于长坂遭曹军追上；张飞断后，赵云救主，奠定孙刘联盟基础。')
...
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, kind = EXCLUDED.kind, time_mode = EXCLUDED.time_mode, precision = EXCLUDED.precision, date_note = EXCLUDED.date_note, at_year = EXCLUDED.at_year, at_month = EXCLUDED.at_month, at_abs = EXCLUDED.at_abs, start_year = EXCLUDED.start_year, start_month = EXCLUDED.start_month, start_abs = EXCLUDED.start_abs, end_year = EXCLUDED.end_year, end_month = EXCLUDED.end_month, end_abs = EXCLUDED.end_abs, summary = EXCLUDED.summary;
INSERT INTO events (id, name, kind, time_mode, precision, date_note, at_year, at_month, at_abs, start_year, start_month, start_abs, end_year, end_month, end_abs, summary) VALUES ('jieting', '街亭之战', 'battle', 'point', 'year', '建兴六年春，228年', 228, 1, 2736, NULL, NULL, NULL, NULL, NULL, NULL, '诸葛亮第一次北伐，马谡守街亭违令，兵败于张郃，蜀军被迫撤退。')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, kind = EXCLUDED.kind, time_mode = EXCLUDED.time_mode, precision = EXCLUDED.precision, date_note = EXCLUDED.date_note, at_year = EXCLUDED.at_year, at_month = EXCLUDED.at_month, at_abs = EXCLUDED.at_abs, start_year = EXCLUDED.start_year, start_month = EXCLUDED.start_month, start_abs = EXCLUDED.start_abs, end_year = EXCLUDED.end_year, end_month = EXCLUDED.end_month, end_abs = EXCLUDED.end_abs, summary = EXCLUDED.summary;
...
-- relations
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-changban-liu-bei', 'event', 'changban', 'person', 'liu-bei', 'battle') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-xiaoyaojin-zhang-liao', 'event', 'xiaoyaojin', 'person', 'zhang-liao', 'battle') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-hanzhong-liu-bei', 'event', 'hanzhong', 'person', 'liu-bei', 'battle') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-dingjunshan-huang-zhong', 'event', 'dingjunshan', 'person', 'huang-zhong', 'battle') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-xiangfan-guan-yu', 'event', 'xiangfan', 'person', 'guan-yu', 'battle') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-jieting-zhuge', 'event', 'jieting', 'person', 'zhuge-liang', 'battle') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-shiting-lu-xun', 'event', 'shiting', 'person', 'lu-xun', 'battle') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-wuzhangyuan-zhuge', 'event', 'wuzhangyuan', 'person', 'zhuge-liang', 'battle') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-yiling-lu-xun', 'event', 'yiling', 'person', 'lu-xun', 'battle') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
