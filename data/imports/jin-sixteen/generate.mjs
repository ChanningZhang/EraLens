...
import { dynastyGroupSql, dynastySql, formatAppellationCsv, mergeAppellationsIntoPersons, normalizeYearPrecisionAt, personSql, reignSql } from "../lib/sqlHelpers.mjs";
...
const persons = [
  ...
  person("sima-ye", "司马邺", ["皇帝"], "晋愍帝，西晋末代皇帝。313年在长安即位；316年长安陷落后出降汉赵，被迁至平阳，318年遇害。", "司马邺"),
  // 东晋
  ...
  // 非帝王人物
  person("jia-nanfeng", "贾南风", ["皇后", "政治家"], "晋惠帝皇后，擅权朝政，引发八王之乱。", "贾南风", ym(257), ym(300)),
  person("xie-xuan", "谢玄", ["军事家"], "东晋名将，淝水之战前线指挥，大破前秦。", "谢玄", ym(343), ym(388)),
  person("zu-ti", "祖逖", ["军事家"], "东晋北伐名将，中流击楫，收复河南。", "祖逖", ym(266), ym(321)),
  person("wang-xizhi", "王羲之", ["书法家"], "东晋书法家，书圣，兰亭序作者。", "王羲之", ym(303), ym(361)),
  person("tao-yuanming", "陶渊明", ["诗人"], "东晋诗人，田园诗派开创者，桃花源记作者。", "陶渊明", ym(365), ym(427)),
  person("gu-kaizhi", "顾恺之", ["画家"], "东晋画家，女史箴图、洛神赋图传为其作。", "顾恺之", ym(348), ym(409)),
];
...
const dynasties = [
  {
    ...
    precision: "month",
    note: "司马炎代魏建晋，都洛阳；永嘉之乱后愍帝在长安即位，316年12月出降汉赵，西晋灭亡。",
  },
  {
    id: "jin-east",
    name: "东晋",
  ...
  },
  {
    ...
    precision: "year",
    groupId: "wuhu",
    note: "350年苻洪据关中称三秦王，前秦政权建立；352年苻健称帝。苻坚一度统一北方，淝水之战后崩溃。",
  },
  {
    id: "yan-back",
    name: "后燕",
...
const jinEastReigns = [
  ...
  dynastyReign(
    ...
    365,
    371,
    eras("reign-sima-yi-jin", [{ name: "太和", sy: 366, ey: 371 }]),
  ),
  dynastyReign(
    "jin-east",
    "sima-yu-jin",
    ...
    371,
    372,
    eras("reign-sima-yu-jin", [{ name: "咸安", sy: 371, ey: 372 }]),
  ),
  dynastyReign(
    "jin-east",
    "sima-yao",
...
const events = [
  ...
  eventPoint({
    ...
    participantIds: ["fu-jian-ming", "sima-yao", "xie-an", "xie-xuan"],
...
const finalized = finalizeImportReigns("jin-sixteen", persons, reigns);
