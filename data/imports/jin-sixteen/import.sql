...
INSERT INTO reigns (
  ...
  'reign-sima-zhong', 'jin-west', 'sima-zhong', '晋惠帝',
  '孝惠皇帝', NULL, '{"kind":"posthumous","name":"晋惠帝"}'::jsonb,
  290, 1, 306, 12,
  3480, 3683, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-sima-chi', 'jin-west', 'sima-chi', '晋怀帝',
  '孝怀皇帝', NULL, '{"kind":"posthumous","name":"晋怀帝"}'::jsonb,
  306, 1, 312, 12,
  3672, 3755, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-sima-ye', 'jin-west', 'sima-ye', '晋愍帝',
  '孝愍皇帝', NULL, '{"kind":"posthumous","name":"晋愍帝"}'::jsonb,
  313, 1, 316, 12,
  3756, 3803, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-sima-yue', 'jin-east', 'sima-yue', '晋康帝',
  '孝康皇帝', NULL, '{"kind":"posthumous","name":"晋康帝"}'::jsonb,
  342, 1, 344, 12,
  4104, 4139, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-sima-dan', 'jin-east', 'sima-dan', '晋穆帝',
  '孝穆皇帝', NULL, '{"kind":"posthumous","name":"晋穆帝"}'::jsonb,
  344, 1, 361, 12,
  4128, 4343, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-sima-pi', 'jin-east', 'sima-pi', '晋哀帝',
  '孝哀皇帝', NULL, '{"kind":"posthumous","name":"晋哀帝"}'::jsonb,
  361, 1, 365, 12,
  4332, 4391, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-sima-yao', 'jin-east', 'sima-yao', '晋孝武帝',
  '孝武皇帝', NULL, '{"kind":"posthumous","name":"晋孝武帝"}'::jsonb,
  372, 1, 396, 12,
  4464, 4763, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-sima-dezong', 'jin-east', 'sima-dezong', '晋安帝',
  '孝安皇帝', NULL, '{"kind":"posthumous","name":"晋安帝"}'::jsonb,
  396, 1, 419, 12,
  4752, 5039, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-sima-dewen', 'jin-east', 'sima-dewen', '晋恭帝',
  '孝恭皇帝', NULL, '{"kind":"posthumous","name":"晋恭帝"}'::jsonb,
  419, 1, 420, 12,
  5028, 5051, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-li-ban', 'cheng-han', 'li-ban', '成汉哀皇帝',
  '哀皇帝', NULL, '{"kind":"posthumous","name":"成汉哀皇帝"}'::jsonb,
  334, 1, 334, 12,
  4008, 4019, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-li-qi', 'cheng-han', 'li-qi', '成汉幽公',
  NULL, NULL, '{"kind":"regnal","name":"成汉幽公"}'::jsonb,
  335, 1, 338, 12,
  4020, 4067, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-zhang-gui', 'liang-front', 'zhang-gui', '前凉奠基者',
  NULL, NULL, '{"kind":"regnal","name":"前凉奠基者"}'::jsonb,
  301, 1, 314, 12,
  3612, 3779, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-zhang-shi', 'liang-front', 'zhang-shi', '前凉昭王',
  '昭王', NULL, '{"kind":"posthumous","name":"前凉昭王"}'::jsonb,
  314, 1, 320, 12,
  3768, 3851, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-zhang-mao', 'liang-front', 'zhang-mao', '前凉成王',
  '成王', NULL, '{"kind":"posthumous","name":"前凉成王"}'::jsonb,
  320, 1, 324, 12,
  3840, 3899, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-zhang-jun', 'liang-front', 'zhang-jun', '前凉文王',
  '文王', NULL, '{"kind":"posthumous","name":"前凉文王"}'::jsonb,
  324, 1, 346, 12,
  3888, 4163, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-zhang-chonghua', 'liang-front', 'zhang-chonghua', '前凉桓王',
  '桓王', NULL, '{"kind":"posthumous","name":"前凉桓王"}'::jsonb,
  346, 1, 353, 12,
  4152, 4247, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-zhang-zuo', 'liang-front', 'zhang-zuo', '前凉威王',
  '威王', NULL, '{"kind":"posthumous","name":"前凉威王"}'::jsonb,
  353, 1, 355, 12,
  4236, 4271, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-zhang-xuanjing', 'liang-front', 'zhang-xuanjing', '前凉冲王',
  '冲王', NULL, '{"kind":"posthumous","name":"前凉冲王"}'::jsonb,
  355, 1, 363, 12,
  4260, 4367, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-zhang-tianxi', 'liang-front', 'zhang-tianxi', '前凉末王',
  NULL, NULL, '{"kind":"regnal","name":"前凉末王"}'::jsonb,
  363, 1, 376, 12,
  4356, 4523, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-murong-huang', 'yan-front', 'murong-huang', '前燕文明皇帝',
  '文明皇帝', NULL, '{"kind":"posthumous","name":"前燕文明皇帝"}'::jsonb,
  337, 1, 348, 12,
  4044, 4187, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-murong-jun', 'yan-front', 'murong-jun', '前燕景昭皇帝',
  '景昭皇帝', NULL, '{"kind":"posthumous","name":"前燕景昭皇帝"}'::jsonb,
  348, 1, 360, 12,
  4176, 4331, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-fu-jian', 'qin-front', 'fu-jian', '前秦景明皇帝',
  '景明皇帝', NULL, '{"kind":"posthumous","name":"前秦景明皇帝"}'::jsonb,
  351, 1, 355, 12,
  4212, 4271, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-fu-jian-ming', 'qin-front', 'fu-jian-ming', '前秦宣昭皇帝',
  '宣昭皇帝', NULL, '{"kind":"posthumous","name":"前秦宣昭皇帝"}'::jsonb,
  357, 1, 385, 12,
  4284, 4631, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-yao-xing', 'qin-back', 'yao-xing', '后秦文桓皇帝',
  '文桓皇帝', NULL, '{"kind":"posthumous","name":"后秦文桓皇帝"}'::jsonb,
  394, 1, 416, 12,
  4728, 5003, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-qifu-guoren', 'qin-xi', 'qifu-guoren', '西秦武元王',
  '武元王', NULL, '{"kind":"posthumous","name":"西秦武元王"}'::jsonb,
  385, 1, 388, 12,
  4620, 4667, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-qifu-gan', 'qin-xi', 'qifu-gan', '西秦文威皇帝',
  '文威皇帝', NULL, '{"kind":"posthumous","name":"西秦文威皇帝"}'::jsonb,
  388, 1, 412, 12,
  4656, 4955, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-lu-guang', 'liang-back', 'lu-guang', '后凉武皇帝',
  '武皇帝', NULL, '{"kind":"posthumous","name":"后凉武皇帝"}'::jsonb,
  386, 1, 399, 12,
  4632, 4799, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-tufa-wugu', 'liang-south', 'tufa-wugu', '南凉武成王',
  '武成王', NULL, '{"kind":"posthumous","name":"南凉武成王"}'::jsonb,
  397, 1, 399, 12,
  4764, 4799, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-li-gao', 'liang-xi', 'li-gao', '西凉武昭王',
  '武昭王', NULL, '{"kind":"posthumous","name":"西凉武昭王"}'::jsonb,
  400, 1, 417, 12,
  4800, 5015, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-juqu-mengxun', 'liang-north', 'juqu-mengxun', '北凉武宣王',
  '武宣王', NULL, '{"kind":"posthumous","name":"北凉武宣王"}'::jsonb,
  397, 1, 433, 12,
  4764, 5207, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-murong-de-yan', 'yan-south', 'murong-de-yan', '南燕献武皇帝',
  '献武皇帝', NULL, '{"kind":"posthumous","name":"南燕献武皇帝"}'::jsonb,
  398, 1, 405, 12,
  4776, 4871, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-feng-ba', 'yan-north', 'feng-ba', '北燕文成皇帝',
  '文成皇帝', NULL, '{"kind":"posthumous","name":"北燕文成皇帝"}'::jsonb,
  407, 1, 430, 12,
  4884, 5171, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  'reign-helian-bobo', 'xia-hu', 'helian-bobo', '胡夏武皇帝',
  '武皇帝', NULL, '{"kind":"posthumous","name":"胡夏武皇帝"}'::jsonb,
  407, 1, 425, 12,
  4884, 5111, 'year'
)
ON CONFLICT (id) DO UPDATE SET
