...
INSERT INTO relations (id, from_type, from_id, to_type, to_id, kind) VALUES ('rel-sun-quan-sun-liang-succession', 'person', 'sun-quan', 'person', 'sun-liang', 'succession') ON CONFLICT (from_type, from_id, to_type, to_id, kind) DO NOTHING;
