...
const persons = [
  ...
  // 元末割据——称帝/称王者
  person("xu-shouhui", "徐寿辉", ["皇帝"], "元末红巾军领袖，1351年称帝，国号宋，传世文献多作天完；1360年为陈友谅所杀。明玉珍追谥应天启运献武皇帝，庙号世宗。", "徐寿辉", ym(1320), ym(1360)),
  ...
  person("ming-yuzhen", "明玉珍", ["皇帝"], "元末明夏建立者，徐寿辉部将，1362年重庆称帝，国号夏，据有两川；病逝后谥钦文昭武皇帝，庙号太祖。", "明玉珍", ym(1329), ym(1366)),
  ...
  // 明
  person("zhu-yuanzhang", "朱元璋", ["皇帝"], "出身濠州贫苦农家，参加郭子兴领导的红巾军后崛起，攻占集庆并经营应天；鄱阳湖之战击败陈友谅，继而平定江南诸势力。1368年称帝建立明朝，定都南京；在位期间整饬吏治、编制黄册鱼鳞图册，并废丞相以强化中央集权。", "朱元璋"),
...
const yuanReignsMain = [
  ...
  drDay("yuan", "togon-temur", "元惠宗", "顺帝", "惠宗", 1368, 1, 23, 1370, 5, 23, [{ name: "至正", sy: 1368, ey: 1370 }], null, "reign-togon-temur-yuan-north"),
...
const yuanMoReigns = [
  ...
  dr("song-xu", "xu-shouhui", "徐宋世宗", "应天启运献武皇帝", "世宗", 1351, 1360, [
  ...
  // 谥号钦文昭武皇帝、庙号太祖，见中/英文维基「明玉珍」及《玄宫之碑》。
  dr("xia-ming", "ming-yuzhen", "明夏太祖", "钦文昭武皇帝", "太祖", 1362, 1366, [{ name: "天统", sy: 1363, ey: 1366 }]),
...
const preSql = [
  ...
  "DELETE FROM events WHERE id = 'qing-moves-capital-to-beijing';",
