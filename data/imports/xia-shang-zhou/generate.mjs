...
const persons = [
  { id: "si-yu", name: "文命", ancestralXing: "姒", altNames: ["禹", "大禹", "夏禹", "文命"], roles: ["君主"], bio: "夏朝开国之君，姒姓，名文命，史称禹、大禹。传说继父鲧治水，受舜禅，都阳城；《史记·夏本纪》以其为夏后氏始。生卒年无实测。", links: wiki("禹") },
  ...
  { id: "ji-chang", name: "昌", ancestralXing: "姬", roles: ["西伯", "君主"], bio: "周文王，商末西伯，武王之父。", links: wiki("周文王") },
  { id: "ji-fa", name: "发", ancestralXing: "姬", roles: ["天子"], bio: "周武王，牧野克商，建立西周。", links: wiki("周武王") },
  ...
  { id: "ji-song", name: "诵", ancestralXing: "姬", roles: ["天子"], bio: "周成王，周公辅政，与康王并称成康之治。", links: wiki("周成王") },
  { id: "ji-zhao", name: "钊", ancestralXing: "姬", roles: ["天子"], bio: "周康王，成康之治后期之王。", links: wiki("周康王") },
  { id: "ji-xia", name: "瑕", ancestralXing: "姬", roles: ["天子"], bio: "周昭王，南征荆楚，传说卒于汉水。", links: wiki("周昭王") },
  { id: "ji-man", name: "满", ancestralXing: "姬", roles: ["天子"], bio: "周穆王，西周在位最久的天子之一。", links: wiki("周穆王") },
  { id: "ji-yihu", name: "繄扈", ancestralXing: "姬", roles: ["天子"], bio: "周共王，穆王之子。", links: wiki("周共王") },
  { id: "ji-jian", name: "囏", ancestralXing: "姬", roles: ["天子"], bio: "周懿王，断代工程以元年天再旦为前899年。", links: wiki("周懿王") },
  { id: "ji-pifang", name: "辟方", ancestralXing: "姬", roles: ["天子"], bio: "周孝王，共王之弟，继懿王而立。", links: wiki("周孝王") },
  { id: "ji-xie", name: "燮", ancestralXing: "姬", roles: ["天子"], bio: "周夷王。", links: wiki("周夷王") },
  { id: "ji-hu", name: "胡", ancestralXing: "姬", roles: ["天子"], bio: "周厉王，专利引发国人暴动，出奔于彘。", links: wiki("周厉王") },
  { id: "ji-jing", name: "静", ancestralXing: "姬", roles: ["天子"], bio: "周宣王，共和之后即位，史称宣王中兴。", links: wiki("周宣王") },
  { id: "ji-gongsheng", name: "宫湦", ancestralXing: "姬", roles: ["天子"], bio: "周幽王，犬戎之祸中身死，西周终结。", links: wiki("周幽王") },
  {
    id: "ji-yijiu",
    name: "宜臼",
    ancestralXing: "姬",
  ...
  { id: "ji-lin", name: "林", ancestralXing: "姬", roles: ["天子"], bio: "周桓王。", links: wiki("周桓王") },
  { id: "ji-tuo", name: "佗", ancestralXing: "姬", roles: ["天子"], bio: "周庄王。", links: wiki("周庄王") },
  { id: "ji-huqi", name: "胡齐", ancestralXing: "姬", roles: ["天子"], bio: "周釐王，亦作周僖王。", links: wiki("周釐王") },
  { id: "ji-lang", name: "阆", ancestralXing: "姬", roles: ["天子"], bio: "周惠王，其间有王子颓之乱。", links: wiki("周惠王") },
  { id: "ji-zheng", name: "郑", ancestralXing: "姬", roles: ["天子"], bio: "周襄王，晋文公勤王前后在位。", links: wiki("周襄王") },
  { id: "ji-renchen", name: "壬臣", ancestralXing: "姬", roles: ["天子"], bio: "周顷王。", links: wiki("周顷王") },
  { id: "ji-ban", name: "班", ancestralXing: "姬", roles: ["天子"], bio: "周匡王。", links: wiki("周匡王") },
  { id: "ji-yu", name: "瑜", ancestralXing: "姬", roles: ["天子"], bio: "周定王。", links: wiki("周定王") },
  { id: "ji-yi", name: "夷", ancestralXing: "姬", roles: ["天子"], bio: "周简王。", links: wiki("周简王") },
  { id: "ji-xiexin", name: "泄心", ancestralXing: "姬", roles: ["天子"], bio: "周灵王。", links: wiki("周灵王") },
  { id: "ji-gui", name: "贵", ancestralXing: "姬", roles: ["天子"], bio: "周景王。", links: wiki("周景王") },
  { id: "ji-meng", name: "猛", ancestralXing: "姬", roles: ["天子"], bio: "周悼王，在位仅数月。", links: wiki("周悼王") },
  { id: "ji-gai", name: "匄", ancestralXing: "姬", roles: ["天子"], bio: "周敬王，春秋与战国之交的周天子。", links: wiki("周敬王") },
  { id: "ji-ren", name: "仁", ancestralXing: "姬", roles: ["天子"], bio: "周元王。", links: wiki("周元王") },
  { id: "ji-jie", name: "介", ancestralXing: "姬", roles: ["天子"], bio: "周贞定王。", links: wiki("周贞定王") },
  { id: "ji-quji", name: "去疾", ancestralXing: "姬", roles: ["天子"], bio: "周哀王。史记：立三月，为弟叔袭杀。", links: wiki("周哀王") },
  { id: "ji-shu", name: "叔", ancestralXing: "姬", roles: ["天子"], bio: "周思王。史记：杀哀王而立，立五月，旋为考王所杀。", links: wiki("周思王") },
  { id: "ji-wei", name: "嵬", ancestralXing: "姬", roles: ["天子"], bio: "周考王。", links: wiki("周考王") },
  { id: "ji-wu", name: "午", ancestralXing: "姬", roles: ["天子"], bio: "周威烈王，前403年命韩赵魏为诸侯。", links: wiki("周威烈王") },
  { id: "ji-jiao", name: "骄", ancestralXing: "姬", roles: ["天子"], bio: "周安王。", links: wiki("周安王") },
  { id: "ji-xi", name: "喜", ancestralXing: "姬", roles: ["天子"], bio: "周烈王。", links: wiki("周烈王") },
  { id: "ji-bian", name: "扁", ancestralXing: "姬", roles: ["天子"], bio: "周显王。", links: wiki("周显王") },
  { id: "ji-ding", name: "定", ancestralXing: "姬", roles: ["天子"], bio: "周慎靓王。", links: wiki("周慎靓王") },
  { id: "ji-yan", name: "延", ancestralXing: "姬", roles: ["天子"], bio: "周赧王，东周末代天子，前256年周亡于秦。", links: wiki("周赧王") },
