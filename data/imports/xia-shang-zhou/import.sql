...
INSERT INTO reigns (
  ...
  '武王', '太祖', '{"kind":"posthumous","name":"商汤"}'::jsonb,
  -1600, 1, -1571, 12,
  -19188, -18829, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  '太甲', '太宗', '{"kind":"posthumous","name":"商太甲"}'::jsonb,
  -1560, 1, -1548, 12,
  -18708, -18553, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  '太戊', '中宗', '{"kind":"posthumous","name":"商太戊"}'::jsonb,
  -1494, 1, -1420, 12,
  -17916, -17017, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  '武丁', '高宗', '{"kind":"posthumous","name":"商武丁"}'::jsonb,
  -1250, 1, -1192, 12,
  -14988, -14281, 'year'
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO reigns (
  ...
  '帝乙', NULL, '{"kind":"posthumous","name":"帝乙"}'::jsonb,
  -1101, 1, -1076, 12,
  -13200, -12889, 'year'
)
ON CONFLICT (id) DO UPDATE SET
