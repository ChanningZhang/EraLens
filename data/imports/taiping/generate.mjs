...
const manifest = {
  ...
  sources: [
    ...
    { label: "司法部：太平天国与清政府对峙", url: "https://www.moj.gov.cn/pub/sfbgw/jgsz/gjjwzsfbjjz/zyzsfbjjzsj/201910/t20191029_184865.html" },
  ...
  notes: [
    ...
    "金田起义、洪秀全登基、定都天京及幼天王被俘均为太平天国自身事件，只关联太平天国；反清背景、清军参与镇压或事件造成双方对峙，不单独构成清朝事件关联。",
...
writeImportPackage(__dirname, {
  ...
  preSql: "DELETE FROM event_dynasties WHERE event_id IN ('jintian-uprising', 'hong-xiuquan-enthroned', 'taiping-capital-tianjing', 'hong-tianguifu-captured') AND dynasty_id = 'qing';",
  manifest,
});
