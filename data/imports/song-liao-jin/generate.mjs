...
const jinReigns = [
  ...
  drDay("jin-nvzhen", "wanyan-liang", "海陵王", null, null, 1150, 1, 9, 1161, 12, 15),
  drDay("jin-nvzhen", "wanyan-yong", "金世宗", null, "世宗", 1161, 10, 27, 1189, 1, 20, [{ name: "大定", sy: 1161, ey: 1189 }]),
...
const events = [
  ...
  eventPoint({
    ...
    kind: "battle",
    precision: "day",
    dateNote: "绍兴三十一年十一月初八至初九，1161年11月26日至27日",
    at: ymDay(1161, 11, 26),
    dynastyIds: ["song-south", "jin-nvzhen"],
