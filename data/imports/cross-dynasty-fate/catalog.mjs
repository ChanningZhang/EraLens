...
export function buildFateCatalog() {
  return [
    ...
    {
      id: "rel-yang-tong-wang-shichong-killed",
      fromPersonId: "yang-tong",
      toPersonId: "wang-shichong",
      kind: "killed",
      eventId: null,
      resolveAt: () => ym(619, 12),
    },
    {
      id: "rel-dou-jiande-li-shimin-captured",
      fromPersonId: "dou-jiande",
      toPersonId: "li-shimin",
      kind: "captured",
      eventId: null,
      resolveAt: () => ym(621, 12),
    },
    {
      id: "rel-dou-jiande-li-yuan-killed",
      fromPersonId: "dou-jiande",
      toPersonId: "li-yuan",
      kind: "killed",
      eventId: null,
    ...
    {
      id: "rel-yuwen-huaji-dou-jiande-killed",
      fromPersonId: "yuwen-huaji",
      toPersonId: "dou-jiande",
      kind: "killed",
      eventId: null,
      resolveAt: () => ymDay(619, 3, 22),
      precision: "day",
    },
    {
      id: "rel-wang-shichong-li-yuan-surrender",
      fromPersonId: "wang-shichong",
      toPersonId: "li-yuan",
      kind: "surrender",
      eventId: null,
      resolveAt: () => ym(621, 12),
