...
writeImportPackage(__dirname, {
  ...
  preSql: [
    "DELETE FROM relations WHERE id = 'rel-liu-xuan-liu-panzi-killed';",
    "DELETE FROM relations WHERE id = 'rel-wang-shichong-li-shimin-surrender';",
  ...
  manifest: {
    ...
    sources: [
      { label: "周携王：前750年被晋文侯所杀及清华简《系年》纪年", url: "https://zh.wikipedia.org/wiki/周携王" },
      { label: "更始帝：投降上玺绶与后来被杀分属两事", url: "https://zh.wikipedia.org/wiki/更始帝" },
      {
      ...
      { label: "梁简文帝", url: "https://zh.wikipedia.org/wiki/梁简文帝" },
      { label: "羊鵾", url: "https://zh.wikipedia.org/wiki/羊鵾" },
      ...
      { label: "赫连定", url: "https://zh.wikipedia.org/wiki/赫连定" },
      { label: "魏书·世祖纪", url: "https://zh.wikisource.org/zh-hans/魏書/卷4上" },
      ...
      { label: "新唐书·高祖本纪", url: "https://zh.wikisource.org/zh-hans/新唐书/卷001" },
      { label: "窦建德日期考证", url: "https://ctext.org/datawiki.pl?if=en&res=618467" },
    ...
    notes: [
      "周携王于前750年被晋文侯所杀；命运线终点连至晋文侯（jin-r10）在位卡，并绑定既有‘晋文侯杀携王’事件。",
      "刘玄→刘盆子为投降上玺绶，改为surrender并清理旧killed记录；后被张卬、谢禄谋杀另属一事。来源记25年农历十月请降，未核得可靠公历换算，关系保留年精度并按约定锚在25年12月，不与九月赤眉入长安事件绑定。",
      ...
      "夜郎侯多同（夜郎辛）被杀关系不关联 yelang-xin-killed：该 ID 在事件目录已指向‘夜郎自大’成语（前122），并非其被杀事件（前27）。",
      ...
      "补入萧纲于551年11月15日被侯景杀害、侯景于552年5月26日败亡被杀的命运线；侯景实际由部下羊鵾行刺，时间轴接收方按讨伐主导者与后即位的萧绎卡片处理。",
      ...
      "补入窦建德被李世民俘虏、后奉唐高祖之命处死，以及王世充向李世民投降等命运线；年精度关系落在年桶右缘。王世充赴蜀途中为仇家独孤修德所杀，接收方不是在位君主，不另画命运线。",
      "补齐王世充前后线：杨侗于619年被王世充派人毒杀（《资治通鉴》卷187），新增杨侗→王世充 killed；王世充于621年率东都投降李世民。",
      "王世充→李世民投降线未显示，是因为李世民在621年尚无在位卡；按接收方缺少当时卡片时改挂当时在位君主的通用规则，将命运线目标设为唐高祖李渊。王世充实际向李世民投降。",
      "新增宇文化及→窦建德 killed：据《新唐书·高祖本纪》记武德二年闰二月辛丑窦建德杀宇文化及，日期换算为公历619-03-22；《旧唐书·高祖本纪》亦载窦建德攻聊城斩宇文化及。",
      ...
      "李煜卒日按徐鉉墓志铭记太平兴国三年七月初八；《九国志》另记初七。方震华考辨指出宋代材料有异，牵机药及词句致祸叙事见南宋《默记》，应视作后出传说。日期关系按本目录的978-07-08口径存储。",
