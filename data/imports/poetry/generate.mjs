...
const events = [
  ...
  poemPoint({ id: "poetry-bie-yunjian", name: "《别云间》", year: 1645, dynastyIds: ["ming-south"], participantIds: ["xia-wanchun"], dateNote: "弘光元年，抗清被捕前后", summary: "夏完淳被捕前所作，表现南明抗清与少年殉国。" }),
...
const poemTexts = {
  ...
  "poetry-bie-yunjian": `三年羁旅客，今日又南冠。\n无限山河泪，谁言天地宽。\n已知泉路近，欲别故乡难。\n毅魄归来日，灵旗空际看。`,
