...
const persons = [
  ...
  { id: "xiao-he", name: "萧何", roles: ["政治家"], bio: "汉初相国，定都长安、制律令，与韩信、张良并称三杰。", links: wiki("萧何") },
  { id: "han-xin", name: "韩信", roles: ["军事家"], bio: "汉初大将，破赵燕齐楚，垓下围项羽，后遭诛。", links: wiki("韩信") },
  { id: "zhang-liang", name: "张良", roles: ["政治家", "军事家"], bio: "汉初谋臣，鸿门宴护刘邦，功成身退。", links: wiki("张良") },
