...
import { dynastySql, formatAppellationCsv, mergeAppellationsIntoPersons, normalizeYearPrecisionAt, personSql, reignSql } from "../lib/sqlHelpers.mjs";
...
const dynasties = [
  ...
  },
  {
    ...
    precision: "month",
    note: "以刘邦前202年2月称帝、定国号汉为西汉正式建国边界；前206年受封汉王为前置政权史，不并入王朝行。孺子婴于9年1月10日禅让，王莽代汉，西汉终结。",
  },
  {
    id: "xin",
    name: "新",
    ...
    precision: "month",
    note: "王莽于9年1月10日受孺子婴禅让，改国号为新；地皇四年绿林攻入长安，王莽被杀。",
  },
  {
    id: "han-gengshi",
    name: "更始",
  ...
  },
  {
    ...
    precision: "month",
    note: "25年8月刘秀即位重建汉室，定都洛阳；220年11月献帝禅让曹丕，东汉终结。",
  },
];
...
const finalized = finalizeImportReigns("qin-han", persons, reigns);
...
const manifest = {
  ...
  sources: [
    ...
    { label: "《史记·秦始皇本纪》", url: "https://ctext.org/shiji/qin-shi-huang-ben-ji/zhs" },
    { label: "周家台秦墓历谱与秦始皇卒日考证", url: "https://lls.cssn.cn/ztyj/ztyj_zgts/202203/P020220311557775770956.pdf" },
  ],
  notes: [
    ...
    "秦始皇卒日《史记》记为七月丙寅，但周家台秦墓历谱所示该月无丙寅；按相邻八月丙寅推算约落在前210年公历7月，事件仅标月精度，不标日精度。",
