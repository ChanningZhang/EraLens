...
const manifest = {
  ...
  notes: [
    ...
    "新增邹（春秋称邾、邾娄）国君卡：周初始封至邾武公前796年之间连续七世按共同边界均分；前780年邾子夏父至前678年邾子克之间，按世系所记的一世失考将三段均分；邾文公等依据君主年表收录。前471年邾子何即位后至邹穆公约前382年之间，依据邾国君主世系图记载的连续世系与两端年代锚点，按君主次序均分前470至前383年：列入何、两位史料缺占位、邾娄考公、两位史料缺占位；何起年为可考锚点，其余边界标 interpolated，邹穆公前382年起点仍标 approximate。学者另有将考公系于鲁文公至宣公时期（约前626至前591年）的说法，与其为前470年后邾隐公曾孙的世系冲突；本包依连续世系与前后锚点均分，并在考公 bio 中说明异说。谱系表对失考世数有一世/二世及“数世”不同记法，本次采用君主世系图列出的何后两世、考公后两世。邹穆公约前382—前330年依地方人物资料，区间标 approximate。",
