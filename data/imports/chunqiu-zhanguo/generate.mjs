...
const PERSON_DETAIL_OVERRIDES = {
  ...
  "zhongshan-r2": {
    bio: "中山桓公，武公后即位，约前406年魏灭中山；约前380年复国，约前350年卒，姓名失载。",
    links: wiki("中山桓公"),
  },
  "zhongshan-r3": {
...
const dynasties = [
  ...
  },
  {
    ...
    precision: "year",
    note: "传世世系上溯至泰伯；《史记·吴太伯世家》记载武王克殷时周章已君吴，本项目以西周建国年（前1046）为周章起年确定锚点。锚点前后的无年表连续君主分别按世系均分，失考边标为 interpolated；寿梦起始保留前585年年表锚点。前473年越灭吴。",
  },
  {
    id: "yue-chunqiu",
    name: "越",
...
const existingEventDynasties = [
  ...
  ["kuiqiu", "song-chunqiu"],
  ["kuiqiu", "wei-weiguo"],
  ["kuiqiu", "zheng-chunqiu"],
  ["kuiqiu", "cao-chunqiu"],
  ["chengpu", "jin-chunqiu"],
  ["chengpu", "chu-chunqiu"],
  ["chengpu", "song-chunqiu"],
  ["chengpu", "cao-chunqiu"],
  ["chengpu", "wei-weiguo"],
...
const manifest = {
  ...
  sources: [
    ...
    { label: "中国国家博物馆：康侯斧题记", url: "https://www.chnmuseum.cn/yj/xscg/xslw/201812/t20181224_36458.shtml" },
    { label: "楚国世系年代研究", url: "https://sinologicalresearch.web.fc2.com/paper/no2/papers/26.pdf" },
  ...
  notes: [
    ...
    "新增邹（春秋称邾、邾娄）国君卡：周初始封至邾武公前796年之间连续七世按共同边界均分；前780年邾子夏父至前678年邾子克之间，按世系所记的一世失考将三段均分；邾文公等依据君主年表收录。前471年邾子何即位后至邹穆公约前382年之间，依据邹国君主世系图的连续世系与两端年代锚点，按君主次序均分前470至前383年：何之后、邾娄考公之前仅列一位失名君主，考公之后至邹穆公之前列两位失名君主；分别以独立 person（persons.name='？'）和 title='？' 记录，不作“史料缺”占位。按修正后的世次数重新均分各在位区间，边界标 interpolated；邹穆公前382年起点仍标 approximate。学者另有将考公系于鲁文公至宣公时期（约前626至前591年）的说法，与其为前470年后邾隐公曾孙的世系冲突；本包依连续世系与前后锚点均分，并在考公 bio 中说明异说。邹穆公约前382—前330年依地方人物资料，区间标 approximate。",
    ...
    "曹叔振铎为曹国始封君：《史记·管蔡世家》记武王克殷后封其于曹。本包以克殷年（前1046）为其起年；维基《曹国》君主表所列前1041—前1016与同表“在位30年”不符，故不采其起年，采用前1046—前1016（30年）。",
