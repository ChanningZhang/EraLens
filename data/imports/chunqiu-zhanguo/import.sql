...
INSERT INTO reigns (
  ...
  'reign-zou-missing-after-he-1', 'zou-state', 'system-missing-ruler', '',
  NULL,
  -455, 1, NULL, -441, 12, NULL,
  -5448, -5269, 'year', 'interpolated', 'interpolated',
  NULL, NULL, NULL, false
)
ON CONFLICT (id) DO UPDATE SET
  dynasty_id = EXCLUDED.dynasty_id,
...
INSERT INTO reigns (
  ...
  'reign-zou-missing-after-he-2', 'zou-state', 'system-missing-ruler', '',
  NULL,
  -440, 1, NULL, -426, 12, NULL,
  -5268, -5089, 'year', 'interpolated', 'interpolated',
  NULL, NULL, NULL, false
)
ON CONFLICT (id) DO UPDATE SET
  dynasty_id = EXCLUDED.dynasty_id,
...
INSERT INTO reigns (
  ...
  NULL,
  -425, 1, NULL, -411, 12, NULL,
  -5088, -4909, 'year', 'interpolated', 'interpolated',
  NULL, NULL, NULL, false
)
ON CONFLICT (id) DO UPDATE SET
  dynasty_id = EXCLUDED.dynasty_id,
...
INSERT INTO reigns (
  ...
  'reign-zou-missing-after-kaogong-1', 'zou-state', 'system-missing-ruler', '',
  NULL,
  -410, 1, NULL, -396, 12, NULL,
  -4908, -4729, 'year', 'interpolated', 'interpolated',
  NULL, NULL, NULL, false
)
ON CONFLICT (id) DO UPDATE SET
  dynasty_id = EXCLUDED.dynasty_id,
...
INSERT INTO reigns (
  ...
  'reign-zou-missing-after-kaogong-2', 'zou-state', 'system-missing-ruler', '',
  NULL,
  -395, 1, NULL, -383, 12, NULL,
  -4728, -4573, 'year', 'interpolated', 'interpolated',
  NULL, NULL, NULL, false
)
ON CONFLICT (id) DO UPDATE SET
  dynasty_id = EXCLUDED.dynasty_id,
